...
function _s_setup() {
	...
	add_image_size('slides', 690, 260, true);
...
function hw21_customize_register( $wp_customize ) {
	$wp_customize->add_section( 'hw21_social_links' , array(
		'title'      => __( 'Social links', 'hw21' ),
		'priority'   => 30,
	) );
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'social_links_facebook', array(
		'label'        => __( 'Facebook', 'hw21' ),
		'section'    => 'hw21_social_links',
